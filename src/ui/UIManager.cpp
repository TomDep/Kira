...
UIManager::UIManager(Inspector* inspector) {
...
int UIManager::init() {
    ...
    SDL_WindowFlags window_flags = (SDL_WindowFlags)(SDL_WINDOW_OPENGL | SDL_WINDOW_RESIZABLE | SDL_WINDOW_MAXIMIZED);
...
void UIManager::cleanUp() {
    ...
    SDL_GL_DeleteContext(current_context);
	SDL_Quit();
}